...
class PokemonRepositoryManager @Inject constructor (private val pokemonApi: PokemonApi): PokemonSource {
    ...
    override suspend fun getPokemonDetail(name: String): Response<PokemonDetailQuery.Data> {
        return  pokemonApi.getApolloClient().query(PokemonDetailQuery(name)).await()
    }
